...
int registro() //função reponsavel por cadastrar os usuário no sitema
{
	//inicio criação de varieveis/strings
	char arquivo[40];
    char cpf[40];
    char nome[40];
    char sobrenome[40];
    char cargo[40];
    //final da criação de varieveis/strings
    
    printf("Digite o CPF a ser cadatrado: "); //coletando informções do usuário
...
int main()
   {
	int opcao=0; //Definindo varieveis
	int laco=1;
